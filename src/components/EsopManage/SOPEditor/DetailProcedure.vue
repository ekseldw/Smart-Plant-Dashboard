<template>
  <div class="DetailProcedure">
     <div class = "scrollBlind scrollbar" style="overflow-y:scroll; height:90vh;">
    <h2>임무 내용 작성
    <!--button type="button"
...
import contentModal from "@/components/EsopManage/SOPEditor/contentModal.vue";
import EditContentModal from "@/components/EsopManage/SOPEditor/EditContentModal.vue";
...
.scrollBlind {-ms-overflow-style: none; /* IE and Edge */scrollbar-width: none; /* Firefox */}
.scrollBlind::-webkit-scrollbar {display: none; /* Chrome, Safari, Opera*/}
